...
character conversion and is useful for custom glyphs or animations. Use the 4-byte overload for 4-digit modules (the
remaining two bytes are cleared), or the 6-byte overload for 6-digit modules.
...
display:
  - platform: tm1637
    ...
    lambda: |-
      ...
      it.set_buffer(0x3f, 0x06, 0x5b, 0x4f | 0x80);
```
